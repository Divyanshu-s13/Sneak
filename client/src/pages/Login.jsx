  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        <img src={assets.logo} alt="" className='h-32 md:h-40 object-contain'/>
        <div>
            ...
            <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>connect with global community on sneak.</p>
        </div>
